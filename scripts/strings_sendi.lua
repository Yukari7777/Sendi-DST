...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_HAT_CROWN = "이제.. 제가 고기를 들고있어도 싫지 않으신가요? 버니맨?"
--군주의 왕관
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_RAPIER = "제가 애용하던것과 닮은 레이피어에요! 수제지만 예쁘죠?"
--센디 레이피어
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_RAPIER_IGNIA = "끊임없이 타오르고있어요.../n방대한 에너지가 느껴집니다!"
--센디 이그니아 레이피어
STRINGS.NAMES.SENDIPACK = "센디의 책가방"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDIPACK = "제가.. 저를 기억할 수 있게 해주는 가방이에요."
--센디팩
STRINGS.NAMES.SENDI_ARMOR_02 = "센디의 라이프아머"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_ARMOR_02 = "기존의 갑옷의 갑옷보다 조금더 튼튼하고 효율적으로 만들었어!"
--센디 오븐
STRINGS.NAMES.SENDI_OVEN = "센디의 오븐"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_OVEN = "한번에 구워 버리는거에요!/n여러번 구우면 귀찮잖아요?"

--------레시피 추가
STRINGS.SENDITABNAME = "센디탭"
STRINGS.RECIPE_DESC.SENDIPACK = "냉장고 기능이 달린 가방입니다."
STRINGS.RECIPE_DESC.SENDISEDMASK = "슬픈 사연이 담긴 마스크.[방수]"
